...
public abstract class Legemiddel {
    ...
    protected int pris;
    protected float virkemasse;// En verdi i mg for mengden av relevant virkestoff
    
    protected Legemiddel(String navn, int pris, float virkemasse){// Konstruktør
        this.navn = navn;
        this.pris=pris;
    ...
    public float hentVirkestoff(){return virkemasse;}
